...
<div class="jumbotron"><h2 class="text-center">WELCOME TO DRUGS - ONLINE PORTAL</h2><h2 class="text-center">ADD PHARMACY</h2></div>
	...
	<div class="container-fluid">
		<form:form commandName="pharmacy" action="addPharmacy.htm" method="post">
			<div class="row">
			<div class="col-md-3">Pharmacy Name :</div>
			<div class="col-md-3"><form:input type="text" path="pharmacyName" class="form-control" placeholder ="Pharmacy Name"/><font color="red"><form:errors path="pharmacyName"/></font></div>
			<div class="col-md-3">Manager Name :</div>
			<div class="col-md-3"><form:input type="text" path="personName" class="form-control" placeholder ="Manager Name"/><font color="red"><form:errors path="personName"/></font></div>
			</div>
			<div class="row">
			...
			<div class="col-md-3">Manager Age :</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-2">
				<strong class="text-center">MANAGER AGE</strong>
			</div>
		</div>
		<c:forEach items="${pharmacies}" var="ph">
			...
			<div class="col-md-2">
				<strong class="text-center">${ph.personName}</strong>
			</div>
			<div class="col-md-2">
				<strong class="text-center">${ph.pharmacyName}</strong>
			</div>
			<div class="col-md-2">
				<strong class="text-center">${ph.userName}</strong>
			</div>
			<div class="col-md-2">
				<strong class="text-center">${ph.password}</strong>
			</div>
			<div class="col-md-2">
				<strong class="text-center">${ph.age}</strong>
			</div>
		</div>
	...
	<c:if test="${count == 0}">
		<strong class="text-center">NO PHARMACIES CREATED</strong>
	</c:if>
