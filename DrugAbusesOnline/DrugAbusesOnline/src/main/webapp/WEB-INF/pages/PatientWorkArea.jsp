...
<c:if test="${(user.personName != null) && (user.type == 'Person')}">
...
<form action="${logoutUrl}" method="post" id="logoutForm">
	...
	<div class="container-fluid">
		<div class="row">
		<div class="col-md-4">
		<a href="appointment.htm"><button type="button" class="btn btn-primary">ADD APPOINTMENT</button></a>
		</div>
	</div>
	</div>
	<script>
